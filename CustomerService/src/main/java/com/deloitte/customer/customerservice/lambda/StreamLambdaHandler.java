package com.deloitte.customer.customerservice.lambda;
...
import com.deloitte.customer.customerservice.CustomerServiceApplication;
...
public class StreamLambdaHandler implements RequestStreamHandler{
    ...
    static { 
       try { 
           handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(CustomerServiceApplication.class);
